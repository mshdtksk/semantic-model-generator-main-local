...
--CREATE OR REPLACE STREAMLIT CORTEX_ANALYST_SEMANTICS.SEMANTIC_MODEL_GENERATOR.SEMANTIC_MODEL_GENERATOR→CREATE OR REPLACE STREAMLIT SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE
--ROOT_LOCATION = '@CORTEX_ANALYST_SEMANTICS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator'→ROOT_LOCATION = '@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator'
CREATE OR REPLACE STREAMLIT SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE
ROOT_LOCATION = '@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator'
MAIN_FILE = 'app.py'
--TITLE = "Semantic Model Generator"→TITLE = "Semantic Model Generator Local"
--IMPORTS = ('@cortex_analyst_semantics.semantic_model_generator.streamlit_stage/looker_sdk.zip',→IMPORTS = ('@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/looker_sdk.zip',
--'@cortex_analyst_semantics.semantic_model_generator.streamlit_stage/strictyaml.zip')→'@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/strictyaml.zip')
TITLE = "Semantic Model Generator Local"
IMPORTS = ('@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/looker_sdk.zip',
'@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/strictyaml.zip')
...
--CREATE OR REPLACE PROCEDURE CORTEX_ANALYST_SEMANTICS.SEMANTIC_MODEL_GENERATOR.ZIP_SRC_FILES(→CREATE OR REPLACE PROCEDURE SEMANTIC_MODEL_GENERATOR.ZIP_SRC_FILES(
CREATE OR REPLACE PROCEDURE SEMANTIC_MODEL_GENERATOR.ZIP_SRC_FILES(
    database STRING,
    schema STRING,
    stage STRING,
    source_path STRING,
...
--CALL CORTEX_ANALYST_SEMANTICS.SEMANTIC_MODEL_GENERATOR.ZIP_SRC_FILES(→CALL SEMANTIC_MODEL_GENERATOR.ZIP_SRC_FILES(
--    'CORTEX_ANALYST_SEMANTICS',→    '[YOUR_STREAM_DATABASE]',
CALL SEMANTIC_MODEL_GENERATOR.ZIP_SRC_FILES(
...
--CREATE OR REPLACE PROCEDURE CORTEX_ANALYST_SEMANTICS.SEMANTIC_MODEL_GENERATOR.GENERATE_SEMANTIC_FILE(→CREATE OR REPLACE PROCEDURE SEMANTIC_MODEL_GENERATOR.GENERATE_SEMANTIC_FILE(
CREATE OR REPLACE PROCEDURE SEMANTIC_MODEL_GENERATOR.GENERATE_SEMANTIC_FILE(
    STAGE_NAME STRING,
    MODEL_NAME STRING,
    SAMPLE_VALUE INT,
    ALLOW_JOINS BOOLEAN,
...
--IMPORTS = ('@CORTEX_ANALYST_SEMANTICS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator.zip',→IMPORTS = ('@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator.zip',
--    '@cortex_analyst_semantics.semantic_model_generator.streamlit_stage/strictyaml.zip'→    '@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/strictyaml.zip'
IMPORTS = ('@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator.zip',
    '@SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/strictyaml.zip'
            )
